...
CREATE POLICY "Users create own profile" ON "public"."profiles" FOR INSERT WITH CHECK (((("current_setting"('request.jwt.claims'::"text", true))::"jsonb" ->> 'sub'::"text") = "user_id"));



CREATE POLICY "Users update own profile" ON "public"."profiles" FOR UPDATE USING (((("current_setting"('request.jwt.claims'::"text", true))::"jsonb" ->> 'sub'::"text") = "user_id"));



CREATE POLICY "Users view own profile" ON "public"."profiles" FOR SELECT USING (((("current_setting"('request.jwt.claims'::"text", true))::"jsonb" ->> 'sub'::"text") = "user_id"));



CREATE POLICY "View active profiles" ON "public"."profiles" FOR SELECT USING (("is_active" = true));
